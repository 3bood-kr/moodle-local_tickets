 ...
 */
 ...
 $string['records'] = 'نتائج';
 $string['no_tickets_found'] = 'لا يوجد نتائج.';
 $string['confirm_ticket_delete'] = 'هل انت متأكد من حذف هذه التذكرة؟';
 $string['edit_status'] = 'تعديل الحالة';
