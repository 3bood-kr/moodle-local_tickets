...
$string['ticket_submission_success'] = 'Ticket Submitted Successfully';
...
$string['no_tickets_found'] = 'No Tickets Found.';
$string['confirm_ticket_delete'] = 'Are you sure yo want to delete this ticket?';
$string['edit_status'] = 'Edit Status';
$string['numbersetting'] = 'Number Setting';
$string['numbersetting_desc'] = 'Enter a number for the setting. This number will be used for ...';
$string['local_tickets'] = 'Local Tickets';
$string['ticketspagesize'] = 'Tickets Page Size';
$string['commentspagesize'] = 'Comments Page Size';
